  ...
  return (
    <div className={styles["main-div"]}>
      ...
      <div className={styles.cardContainer}>
        {db.map((character, index) => (
          <TinderCard
            ...
            key={character.name}
            onSwipe={(dir) =>
              swiped(dir, character.name, character.email, index)
            }
      ...
      <div className={buttonsStyles.swipeButtons}>
        ...
        <IconButton
          className={buttonsStyles.swipeButtons__left}
          onClick={() => swipe("left")}
        >
        ...
        <IconButton
          className={buttonsStyles.swipeButtons__right}
          onClick={() => swipe("right")}
        >
