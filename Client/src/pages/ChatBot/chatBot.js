...
function ChatBotComp() {
    ...
    const steps = [
        ...
        {
            id:"Show Menu",
            options: [{value: "music", label: "Craft Me A Shared Music Playlist", trigger: "Show Music" },
                    {value: "movies", label: "Suggest Me Movies For Date Night", trigger: "Show Movies"},
                    {value: "conversation", label: "Suggest Me An Interesting Conversation Starter", trigger: "Show Conversation Starter"},
                    {value: "openning_line", label: "Suggest Me An Openning Line ", trigger: "Show Openning Line"}]
        },
        {
            id:"Show Music",
        ...
        },
        {
            ...
            component: <AnswerFromGPT type="conversation" user2_email={state.email}/>,
            trigger:"Another Help",
        },
        {
            id:"Show Openning Line",
            component: <AnswerFromGPT type="openning_line" user2_email={state.email}/>,
            trigger:"Another Help",
        },
        {
            id:"Another Help",
    ...
    return (
        ...
        <div className={classes.chatBot}>
            <ChatBot hideSubmitButton="true" headerTitle="Your AI Assist" width="450px" botAvatar={botIcon} userAvatar={state.myPic} steps={steps}/>
        </div>
        </>
    );
}
